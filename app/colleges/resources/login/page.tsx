...
const LoginPage = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Simulate successful login/register and redirect to dashboard
        setTimeout(() => {
            router.push('/colleges/resources/dashboard');
        }, 1000);
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="flex items-center">
                    <Link href="/colleges/resources" className="flex items-center text-purple-600 hover:text-purple-700 transition-colors">
                ...
                <div className="text-center">
                    <h2 className="text-3xl font-extrabold text-gray-900 mb-2">
                        {isLogin ? 'Welcome Back!' : 'Join Studsphere'}
                    </h2>
